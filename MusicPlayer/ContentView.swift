...
//  MusicPlayer
//
//  Created by Lokesh Mandal on 09/10/24.
//
    ...
    var body: some View{
        VStack {
            ...
            Image("tree")
                ...
                .clipShape(Circle())
                .padding(.all, 8)
                .background((Color(#colorLiteral(red: 0.89803921, green: 0.933333333, blue: 1, alpha: 1))))
                .clipShape(Circle())
                .shadow(color: Color.black.opacity(0.35),radius:8, x: 8, y: 7)
            ...
            HStack(spacing: 20){
                ...
                Button{} label: {
                    Image(systemName: isplaying ? "pause.fill" : "play.fill")
                        ...
                        .background(
                            ZStack {
                                Color(#colorLiteral(red: 0.760805010, green: 0.8164883852, blue: 0.9259157777, alpha: 1))
                                ...
                                .clipShape(Circle())
                                .shadow(color: Color(#colorLiteral(red: 0.760805010, green: 0.8164883852, blue: 0.9259157777, alpha: 1)), radius: 20, x: 20, y: 20)
